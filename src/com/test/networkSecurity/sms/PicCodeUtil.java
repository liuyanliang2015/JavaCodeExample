package com.test.networkSecurity.sms;
...
/**
 * Java生成和解析base64图片验证码
 * 一般流程是：
 * 前端调用服务端接口，服务端生成图片验证码(图片流),并存储到服务器例如redis
 * 前端展示图片验证码，用户输入图片验证码，与服务器端做图片验证码验证，验证通过才发送短信验证码
 * 这样就可以防止绝大部分的短信轰炸机程序
...
public class PicCodeUtil {
	...
	public static void main(String arg[]) throws IOException {
		String code = PicCodeUtil.generateVerifyCode(4, VERIFY_CODES);
